...
def main():
    ...
    try:
        ...
        driver.find_element_by_xpath("//input[@aria-label='Username']").send_keys(USERNAME)#"dekarosa22")
    except:
    ...
    driver.find_element_by_xpath("//input[@aria-label='Password']").send_keys(PASSWORD)#"queixo00")
